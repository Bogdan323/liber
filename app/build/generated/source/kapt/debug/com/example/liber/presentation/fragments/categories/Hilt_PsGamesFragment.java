 ...
 */
public abstract class Hilt_PsGamesFragment extends BaseCategoryFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PsGamesFragment_GeneratedInjector) this.generatedComponent()).injectPsGamesFragment(UnsafeCasts.<PsGamesFragment>unsafeCast(this));
    }
  }
